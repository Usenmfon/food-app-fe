        ...
        <DefaultLayout>
            ...
            <Grid item md={12} sm={12} xs={12} textAlign="center">
                <Stack sx={{ display: 'flex', alignItems: 'center', marginBottom: '2rem'}}>
                    <Typography variant="h4" sx={{ marginBottom: '1rem', width: {md: '50vw', xs: '70vw'}, textAlign: 'left'}}>Delivery Information</Typography>
            ...
            <Grid item md={12} sm={12} xs={12} >
                <Box component="form" noValidate display="flex" flexDirection="column" alignItems="center" sx={{ mt: 3, }}>
                    <Stack sx={{ textAlign: 'left' }}>
                        ...
                        <TextField id="outlined-basic" sx={{ marginBottom: '1.5rem', width: {md: '50vw', xs: '70vw'} }} fullWidth name="name" placeholder="Emmanuel Ekpenyong" variant="filled"/>
                    </Stack>
                    <Stack  sx={{marginBottom: '1.5rem', width: {md: '50vw', xs: '70vw'}, display: 'flex', flexDirection: 'row', justifyContent: 'space-between'  }}>
                        <Stack sx={{ textAlign: 'left', width: {md: '20vw', xs: '30vw'}, }}>
                    ...
                    <Stack sx={{ textAlign: 'left', marginBottom: '1.5rem', width: {md: '50vw', xs: '70vw'}  }}>
                    ...
                    <Stack sx={{ textAlign: 'left', marginBottom: '2rem', width: {md: '50vw', xs: '70vw'}  }}>
                    ...
                    <Stack>
                        <Typography sx={{width: {md: '50vw', xs: '70vw', textAlign: 'center', marginBottom: '1rem'}}}>Have something to tell us concerning this delivery, it can be how to locate you etc</Typography>
                    </Stack>
                    <Button type="submit" fullWidth sx={{ marginBottom: '1rem',width: {md: '50vw', xs: '70vw'}, color: 'white' }} variant="contained" color="primary">Proceed to Pay</Button>
                </Box>
            </Grid>
        </Grid>
        </DefaultLayout>
